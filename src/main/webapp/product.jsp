	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<p>
					<b>제조사: </b><%=prod.getManufacturer()%></p>
				<p>
					<b>분류: </b><%=prod.getCategory()%></p>
				<p>
					<b>재고: </b><%=prod.getUnitsInStock()%></p>
				...
				<form action="./processAddCart.jsp?id=<%=prod.getProductId()%>"
					...
					<a href="./cart.jsp" class="btn btn-warning" onclick="addToCart()">장바구니로 이동 &raquo; </a> 
